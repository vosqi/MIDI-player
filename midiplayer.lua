...
owner.Chatted:Connect(function(msg)
    ...
    if split[1] == 'offset' and tostring(split[2]) and tonumber(split[3]) then
        instruments[split[2]][2] = split[3]
    elseif split[1] == 'volume' and tonumber(split[2]) then
        vol = split[2]
    elseif split[1] == 'highgain' and tonumber(split[2]) then
        highgain = split[2]
    elseif split[1] == 'lowgain' and tonumber(split[2]) then
        lowgain = split[2]
    elseif split[1] == 'midgain' and tonumber(split[2]) then
        midgain = split[2]
    elseif split[1] == 'decaytime' and tonumber(split[2]) then
        decaytime = split[2]
    elseif split[1] == 'density' and tonumber(split[2]) then
        density = split[2]
    elseif split[1] == 'diffusion' and tonumber(split[2]) then
        diffusion = split[2]
    elseif split[1] == 'drylevel' and tonumber(split[2]) then
        drylevel = split[2]
    elseif split[1] == 'reverb' and split[2] then
        if split[2]:lower() == 'false' then
            reverbenabled = false
        elseif split[2]:lower() == 'true' then
            reverbenabled = true
        end
        print(reverbenabled)
    elseif split[1] == 'equalizer' and split[2] then
        if split[2]:lower() == 'false' then
            equalizerenabled = false
        elseif split[2]:lower() == 'true' then
            equalizerenabled = true
        end
        print(equalizerenabled)
    end
end)
